...
import 'package:zofa_client/admin/screens/change_bread_price.dart';
import 'package:zofa_client/admin/screens/delete_bread.dart';
        ...
        child: Padding(
          ...
          child: GridView.count(
            ...
            children: const [
              ...
              CustomElevatedButton(
                label: 'עדכון מחירי לחם',
                targetPage: BreadPriceUpdateScreen(),
              ),
              CustomElevatedButton(
                label: 'מחיקת סוגי לחם',
                targetPage: BreadDeleteScreen(),
              ),
            ],
          ),
        ),
