...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  List<Map<String, dynamic>> productDetailsList = []; // List to store product details
    ...
    try {
      ...
      for (var item in orderItems) {
        ...
        fetchFutures.add(fetchProductDetails(productId).then((productDetails) {
          ...
          return {
            'name': productDetails['name'], // Assuming the response has a 'name' field
      ...
      List<Map<String, dynamic>> fetchedProducts = await Future.wait(fetchFutures);
